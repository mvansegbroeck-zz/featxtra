...
// *** This file has been altered *** by Zisis Iason Skordilis
// to include the declaration of the NccfToPov function
// (defined in feat/pitch-functions.cc). This was done to enable use
// of this function in other modules.
// Notice of file modification included to comply with the
// Apache License (see COPYING $4(b)).
